...
const ListProduct = () => {
    ...
    const handlePageChange = (pageNumber) => {
      ...
      // Nếu không phải là admin, không hiển thị trang
      if (!isAdmin) {
          return <div className="container mx-auto py-8">Access denied. You must be an admin to view this page.</div>;
      }
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            <thead className="bg-gray-50">
                                <tr>
                                    ...
                                    <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">RAM</th>
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                ...
                                {currentProducts.map((product, index) => (
                                    <tr key={index}>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{product[8]} VNĐ</td>
